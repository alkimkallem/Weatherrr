...
import edu.dogus.weatherrr.adapters.RecyclerViewAdapter;
import edu.dogus.weatherrr.database.DatabaseQuery;
import edu.dogus.weatherrr.entity.WeatherObject;
import edu.dogus.weatherrr.helpers.CustomSharedPreference;
import edu.dogus.weatherrr.helpers.Helper;
import edu.dogus.weatherrr.json.FiveDaysForecast;
import edu.dogus.weatherrr.json.FiveWeathers;
import edu.dogus.weatherrr.json.Forecast;
import edu.dogus.weatherrr.json.LocationMapObject;
